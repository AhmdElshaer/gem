...
const CollectionsCard = ({title, para}) => {
  return(
    <div className="md:absolute md:h-fit py-4 bg-white md:w-[45%] lg:w-[40%] z-20 md:left-8 lg:left-[5%] pt-3 md:top-1/2 md:-translate-y-1/2 lg:top-1/2 lg:-translate-y-1/2 rounded-lg px-4 md:shadow-2xl">
