...
const CollBanner = ({image, title, description}) => {
  ...
  return(
    <div className="z-30 w-full h-[90vh] flex relative flex-col justify-center items-center">
      ...
      <form onSubmit={onSubmitHandler} className="absolute z-30 bottom-0 w-full h-[15vh] 2xl:h-[10vh] flex flex-row justify-center items-center gap-4 md:gap-8 lg:gap-12 backdrop-blur-md bg-black/30">
