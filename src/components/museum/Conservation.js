    ...
    <div className='conser'>
      <div id="conservation" className="container mx-auto h-full relative px-4 flex flex-col justify-center items-center md:mb-[300px]">
        ...
        <div className='w-full h-4/5 relative flex flex-col'>
          ...
          <div className=' flex flex-col p-6 gap-3 md:w-1/2 lg:w-1/2 md:absolute md:top-[67%] md:left-[30%] lg:left-[27%] bg-white shadow-2xl'>
            <p className='text-orange-500 text-3xl font-bold'>{title}</p>
            <p className='leading-relaxed text-2xl text-stone-500 font-base '>{description}</p>
